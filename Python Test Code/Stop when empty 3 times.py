def main():
  ...
  def LocatePart(jobAlias): #Function to ask PLB to locate a part. INPUT= string PLB job Alias. OUTPUT=list with received part result data
	...
	elif receivedPartMsg[2]!=0 or receivedPartMsg[2]!=3 or receivedPartMsg[2]!=111 or receivedPartMsg[2]!=112 or receivedPartMsg[2]!=113 or receivedPartMsg[2]!=114: #if result not OK and not a license error
